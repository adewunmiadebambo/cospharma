              ...
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-center">
                    <!-- <p>Better living</p> -->
                    <h5>We Bring Perfection With Care</h5>
            ...
            <div class="slider-info  banner-view banner-top1 bg bg2">
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-center">
                    <!-- <p>Dream Home</p> -->
                    <h5>For Us, Quality Matters A Lot</h5>
                    <!-- <a href="about.php" class="btn btn-white">Read More</a> -->
                  </div>
                </div>
              </div>
            ...
            <div class="slider-info banner-view banner-top2 bg bg2">
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-center">
                    <!-- <p>Better living</p> -->
                    <h5>We Know The Power Of Quality</h5>
                    <!-- <a href="about.php" class="btn btn-white">Shop Now</a> -->
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="slider-info banner-view banner-top3 bg bg2">
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-center">
                    <!-- <p>Dream Home</p> -->
                    <h5>For Us Every Single Step Matters</h5>
                    <!-- <a href="about.php" class="btn btn-white">Read More</a> -->
                  </div>
                </div>
              </div>
    ...
    <div class="container py-md-5">
      <div class="row bottom-ab-grids align-items-center">
        ...
        <div class="col-lg-6 bottom-ab-left">
          ...
          <h3 class="hny-title">
          Cospharma Limited</h3>
          <p class="my-3 pr-lg-4">The company weathered all forms of man power-made, institutional, governmental, marketing and societal challenges that initially dogged its way to growth.
          In year 2013, with an eye on the big market, the company recruited the services of well honed, immediately experienced professionals in marketing sales, production and human capital management etc. to drive its wheel of growth...</p>
          ...
          <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
            ...
            <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
              <div class="area-box" style="background: url(assets/images/dist.jpg) no-repeat;">
                ...
                <h4><a href="contact.php.php" class="title-head" style="color: #fff;">Become A Distributor</a></h4> 
              ...
              <div class="testimonial-content">
                <div class="testimonial">
                  <blockquote>
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit beatae integer sit amet .Nulla ex
                    nunc, interdum nec egestas nec, dapibus ac mauris. Vivamus id tempor nisl.
                  </blockquote>
                  <div class="testi-des">
