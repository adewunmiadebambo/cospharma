...
<html lang="zxx">
  ...
  <head>
    ...
    <title>Cospharma Limited | Edge Control Gel</title>
    <!-- google fonts -->
  ...
  <section class="w3l-about-breadcrumb text-left">
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4" style="background: url(assets/images/pgal.jpg) no-repeat;">
      <div class="container py-2">
        <h2 class="title">Edge Control Gel</h2>
   ...
   <!--/contact-->
    ...
    <div class="container py-md-5">
        <div class="row">
            ...
            <div class="col-md-6">
            <img src="assets/images/edge1.jpg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
  </section>
  ...
  <div class="row">
              ...
              <div class="col-md-4">
              <h3> Edge Control Gel</h3>
                <p class="my-3 pr-lg-4">• Formulated to keep the hair lines smooth and well kept. <br>
                                    • Helps to lubricate the hairline to prevent hair loss and scanty look. <br>
                                    • Specialized gel like product that could also be used on natural hair.  </p>
