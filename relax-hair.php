...
<html lang="zxx">
  ...
  <head>
    ...
    <title>Cospharma Limited | Relax Hair Pink Oil</title>
    <!-- google fonts -->
  ...
  <section class="w3l-about-breadcrumb text-left">
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4" style="background: url(assets/images/pgal.jpg) no-repeat;">
      <div class="container py-2">
        <h2 class="title">Relax Hair Pink Oil</h2>
   ...
   <!--/contact-->
    ...
    <div class="container py-md-5">
        <div class="row">
            ...
            <div class="col-md-6">
            <img src="assets/images/pink.jpg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
  </section>
  ...
  <div class="row">
              ...
              <div class="col-md-4">
              <h3> Relax Hair Pink Oil</h3>
                <p class="my-3 pr-lg-4">• It moisturizes the hair making it presentable. <br>
                                • Very helpful in hair fixing or artificial hairs.<br>
                                • It thickens and protects the hair engendering a healthy scalp condition.<br>
                                • Available in 125ml and 250ml pack sizes.</p>
