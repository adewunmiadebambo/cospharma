...
<html lang="zxx">
  ...
  <head>
    ...
    <title>Cospharma Limited | Twist & Lock Gel</title>
    <!-- google fonts -->
  ...
  <section class="w3l-about-breadcrumb text-left">
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4" style="background: url(assets/images/pgal.jpg) no-repeat;">
      <div class="container py-2">
        <h2 class="title">Twist & Lock Gel</h2>
  ...
  <!-- //about breadcrumb -->
   <!--/contact-->
    ...
    <div class="container py-md-5">
        <div class="row">
                <div class="col-md-6">
                    <img src="assets/images/twist.jpg" class="img-fluid" alt="">
                </div>
            <div class="col-md-6">
            <img src="assets/images/twist1.jpg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
  </section>
  ...
  <div class="row">
              ...
              <div class="col-md-4">
              <h3> Twist & Lock Gel</h3>
                <p class="my-3 pr-lg-4">• For people that loves to wear natural hair. <br>
                                    • For people that love twisted hair.<br>
                                    • For people that love to wear neat dreadlock.<br>
                                    • For men and woman that love to look sporty.  </p>
