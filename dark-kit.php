...
<html lang="zxx">
  ...
  <head>
    ...
    <title>Cospharma Limited | Dark Olive Relaxer Kit</title>
    <!-- google fonts -->
  ...
  <section class="w3l-about-breadcrumb text-left">
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4" style="background: url(assets/images/pgal.jpg) no-repeat;">
      <div class="container py-2">
        <h2 class="title">Dark Olive Relaxer Kit</h2>
  ...
  <!-- //about breadcrumb -->
   <!--/contact-->
    ...
    <div class="container py-md-5">
        <div class="row">
                <div class="col-md-6">
                    <img src="assets/images/dark-kit.jpg" class="img-fluid" alt="">
                </div>
            <div class="col-md-6">
            <img src="assets/images/dark1.jpg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
  </section>
